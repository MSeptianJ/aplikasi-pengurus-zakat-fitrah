        ...
        <section class="section-default">
            ...
            <div class="button-box">
                <div class="add-button">
                    <a href="../includes/distribusi-zakat-warga/add-distribusi-zakat-warga/add-distribusi-zakat-warga.php">
                ...
                <div class="button-distribute">
                    <div class="distributes-pages button-current">
                        <a href="javascript:void(0)">Distribusi Warga</a>
                    </div>
                    <div class="distributes-pages">
                        <a href="./distribusi-zakat-lainnya.php">Distribusi Warga Lainnya</a>
                    </div>
                </div>
            </div>
                ...
                <div class="report-distribusi-mustahik">
                    <?php while($data = mysqli_fetch_array($query_report)) : ?>
                            <div class="report-inner-box ">
                                <p>Total Mustahik Warga : <?php echo $data["total-mustahik-warga"]?> Orang</p>
                            </div>
                            <div class="report-inner-box">
